...
export const salads = [
  ...
  { id: 4, name: "Soups", bgColor: "#D9B54B" ,icon: "🍜", items: soups },
  { id: 5, name: "Desserts", bgColor: "#931783" ,icon: "🍰", items: desserts },
  { id: 6, name: "Pizzas", bgColor: "#148C0B" ,icon: "🍕", items: pizzas },
  { id: 7, name: "Alcoholic", bgColor: "#770D0E" ,icon: "🍺", items: alcoholicDrinks },
  { id: 8, name: "Salads", bgColor: "#F580F9" ,icon: "🥗", items: salads }
]